...
import { Upload, Download, FileText, AlertCircle, CheckCircle, XCircle, Eye, Calendar, Loader2 } from 'lucide-react'
import { toast } from 'react-hot-toast'
import Link from 'next/link'
import { useTripsImportWorkflow, useFileValidation } from '@/hooks/useImports'
              ...
              <div className="flex space-x-4">
                ...
                {canImport && (
                  ...
                  >
                    ...
                    {isLoading ? '가져오는 중...' : `${validationResults.valid}개 운행 등록`}
                  </button>
                )}
              </div>
            </div>
          ...
          {validationResults && (
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <ImportResultsDisplay 
                ...
                type="trips"
                onViewDetails={() => window.location.href = '/trips'}
              />
            </div>
          )}
